...
static const _ObjectQuality_type_support_symbol_names_t _ObjectQuality_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, radar_conti_ars408_msgs, msg, ObjectQuality)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, radar_conti_ars408_msgs, msg, ObjectQuality)),
  }
};
...
{
  return &::radar_conti_ars408_msgs::msg::rosidl_typesupport_cpp::ObjectQuality_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, radar_conti_ars408_msgs, msg, ObjectQuality)() {
  return get_message_type_support_handle<radar_conti_ars408_msgs::msg::ObjectQuality>();
}
