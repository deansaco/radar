...
// class ObjectListPublisher : public rclcpp::Node
// {
// public:
//   ObjectListPublisher()
//   : Node("object_list_publisher")
//   {
//     object_list_publisher_ =
//       this->create_publisher<radar_conti_ars408_msgs::msg::ObjectList>("object_list",10);

//     auto publish_msg = [this]() -> void {
//         auto message = radar_conti_ars408_msgs::msg::ObjectList();
//         message.object_count = ***;

//         std::cout <<"publishing object count: " << message.object_count <<std::endl;
//         this->object_list_publisher_->publish(message);
//     };
//     timer_ = this->create_wall_timer(1s, publish_msg);
//   }

//   private:
//   rclcpp::Publisher<radar_conti_ars408_msgs::msg::ObjectList>::SharedPtr object_list_publisher_;
...
// };
    ...
    //##############Task4################   
    // activate Publisher
    //in lifecycle node, message are not published until the node is active
...
/*
//must create handle_cluster_list function similar to handle_object_list
...
// 1. wait for CAN Status Message with # of objects detected
// 2. publish old object data for each object and fill object_list_header, object_count and clear object_map
...
// ##################################
            ...
            //Object List Status
            //if there is a new update for the objectlist, publish the recent data and update time stamp for
            ...
            //for each Obj_1_General message (object ID detected) a new object (named o) has to be created in the map

            //GET function obtains raw value of signal
            //CALC function calculates the physical value of each signal using defined offset and factor from header file
