...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'radar_conti_ars408_msgs.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from radar_conti_ars408_msgs.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from radar_conti_ars408_msgs.srv._add_three_ints import AddThreeInts_Request as Request
    from radar_conti_ars408_msgs.srv._add_three_ints import AddThreeInts_Response as Response
