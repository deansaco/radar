...
#include <stddef.h>
#include "radar_conti_ars408_msgs/msg/detail/num__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  radar_conti_ars408_msgs__msg__Num__init(message_memory);
}

void Num__rosidl_typesupport_introspection_c__Num_fini_function(void * message_memory)
{
  radar_conti_ars408_msgs__msg__Num__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Num__rosidl_typesupport_introspection_c__Num_message_member_array[1] = {
  {
    ...
    offsetof(radar_conti_ars408_msgs__msg__Num, num),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Num__rosidl_typesupport_introspection_c__Num_message_members = {
  ...
  "Num",  // message name
  1,  // number of fields
  sizeof(radar_conti_ars408_msgs__msg__Num),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, radar_conti_ars408_msgs, msg, Num)() {
