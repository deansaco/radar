...
{
  radar_conti_ars408_msgs__msg__FilterStateCfg * msg = (radar_conti_ars408_msgs__msg__FilterStateCfg *)malloc(sizeof(radar_conti_ars408_msgs__msg__FilterStateCfg));
  if (!msg) {
    return NULL;
  }
...
radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence__init(radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (radar_conti_ars408_msgs__msg__FilterStateCfg *)calloc(size, sizeof(radar_conti_ars408_msgs__msg__FilterStateCfg));
    if (!data) {
      return false;
    }
...
{
  radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence * array = (radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence *)malloc(sizeof(radar_conti_ars408_msgs__msg__FilterStateCfg__Sequence));
  if (!array) {
    return NULL;
  }
