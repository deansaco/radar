...
static rosidl_typesupport_introspection_c__MessageMember Frame__rosidl_typesupport_introspection_c__Frame_message_member_array[7] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(can_msgs__msg__Frame, err),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(can_msgs__msg__Frame, rtr),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(can_msgs__msg__Frame, eff),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
