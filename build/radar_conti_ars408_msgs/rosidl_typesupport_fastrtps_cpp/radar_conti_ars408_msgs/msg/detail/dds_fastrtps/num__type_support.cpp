...
#include "radar_conti_ars408_msgs/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const radar_conti_ars408_msgs::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  radar_conti_ars408_msgs::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
...
{
  auto typed_message =
    static_cast<const radar_conti_ars408_msgs::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<radar_conti_ars408_msgs::msg::Num *>(
    untyped_ros_message);
...
{
  return &radar_conti_ars408_msgs::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, radar_conti_ars408_msgs, msg, Num)() {
  return &radar_conti_ars408_msgs::msg::typesupport_fastrtps_cpp::_Num__handle;
}
