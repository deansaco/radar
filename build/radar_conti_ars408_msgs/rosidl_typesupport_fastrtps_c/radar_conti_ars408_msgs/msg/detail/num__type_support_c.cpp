...
#include "radar_conti_ars408_msgs/msg/detail/num__rosidl_typesupport_fastrtps_c.h"
...
using _Num__ros_msg_type = radar_conti_ars408_msgs__msg__Num;
...
size_t get_serialized_size_radar_conti_ars408_msgs__msg__Num(
  const void * untyped_ros_message,
...
static uint32_t _Num__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_radar_conti_ars408_msgs__msg__Num(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_radar_conti_ars408_msgs
size_t max_serialized_size_radar_conti_ars408_msgs__msg__Num(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_radar_conti_ars408_msgs__msg__Num(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, radar_conti_ars408_msgs, msg, Num)() {
